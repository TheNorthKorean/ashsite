      ...
      >
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            ...
            >
              <div className="relative bg-white/4 backdrop-blur-xl border border-white/10 rounded-2xl p-6 h-full hover:bg-white/10 hover:scale-[1.02] transition-all duration-300 group-hover:border-[#00d9ff]/50">
                {/* Icon */}
                <div className="mb-6">
                ...
                <h3 className="text-xl font-medium mb-4 group-hover:text-[#00d9ff] transition-colors duration-300">
                  {feature.title}
                </h3>
